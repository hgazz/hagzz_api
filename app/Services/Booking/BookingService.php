...
class BookingService
{
    ...
    public function cancelBooking($request)
    {
        ...
        $details = [
            ...
            'academy_name' => $join->training->academy->getTranslation('commercial_name', 'en'),
        ];
        $title = "Booking Cancelled";
        $body = "Your booking with {$join->training->academy->getTranslation('commercial_name', 'en')} was Cancelled. Your refund will be processed within 7-14 working days.";
